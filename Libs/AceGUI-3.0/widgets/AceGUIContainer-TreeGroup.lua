...
-------------------------------------------------------------------------------]]
local Type, Version = "TreeGroup", 99
...
local function addLine(self, v, tree, level, parent)
	...
	self.lines[table.getn(self.lines)+1] = line
	return line
end
...
local function OnScrollValueChanged(value)
	local frame = this
...
local function Tree_OnMouseWheel(delta)
	local frame = this
	local self = frame.obj
