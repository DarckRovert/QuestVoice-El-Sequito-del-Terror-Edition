...
-- set current addon path
pfQuestConfig.path = "Interface\\AddOns\\QuestVoice\\quest"
pfQuestConfig.version = tostring(GetAddOnMetadata("QuestVoice", "Version")) or "unknown"
...
pfQuestConfig.title:SetText("|cff33ffccQuest|rVoice " .. L["Config"])
...
function pfQuestConfig:MigrateHistory(...)
  ...
  if match == true then
    DEFAULT_CHAT_FRAME:AddMessage("|cff33ffccQuest|rVoice: " .. L["Quest history migration completed."])
  end
end
...
do -- welcome/init popup dialog
  ...
  pfQuestInit.title:SetText(L["Please select your preferred |cff33ffccQuest|rVoice mode:"])
