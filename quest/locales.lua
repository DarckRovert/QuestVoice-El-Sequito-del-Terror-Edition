local locales = {
  ...
  ["esES"] = {
    ...
    ["Area/Zone"] = "Área/Zona",
    ["Buy"] = "Comprar",
    ["|cff33ffcc<Click>|r Unfold/Fold Objectives\n|cff33ffcc<Right-Click>|r Show In QuestLog\n|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Click>|rDespliega/Pliega Objetivos\n|cff33ffcc<Click-Dcho>|r Mostrar en Log de misiones\n|cff33ffcc<Ctrl-Click>|r Muestra Mapa / Apalanca Color\n|cff33ffcc<Shift-Click>|r Oculta Nodos",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Ctrl-Click>|r Muestra mapa / Cambia color\n|cff33ffcc<Shift-Click>|r Oculta Nodos",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Mark As Done"] = "|cff33ffcc<Ctrl-Click>|r Muestra mapa / Cambia color\n|cff33ffcc<Shift-Click>|r Marca como hecha",
    ["|cff33ffccpf|cffffffffQuest: Tracker is now hidden. Type `/db tracker` to show."] = "|cff33ffccpf|cffffffffMisión: Rastreador está ahora está oculto. Escribe `/db tracker' para mostrar",
    ["|cff33ffccpf|rQuest: New version available! Have a look at http://shagu.org !"] = "|cff33ffccpf|rMisión: Nueva versión disponible! Mira en http://shagu.org !",
    ["Clean"] = "Limpiar",
    ["Clean Database Results"] = "Limpia resultados de la base de datos",
    ["Clean Map"] = "Limpiar mapa",
    ["Click Node To Change Color"] = "Pincha en el nodo para cambiar de color",
    ["Close"] = "Cerrar",
    ["Close & Reload"] = "Cerrar y recargar",
    ["Close Tracker"] = "Cierra restreador",
    ...
    ["Display addon locales"] = "Muestra accesorios locales",
    ...
    ["Display Available Quest Givers"] = "Mostrar los dadores de búsqueda disponibles",
    ["Display Current Quest Givers"] = "Mostrar dadores de misiones actuales",
    ["Display Event & Daily Quests"] = "Mostrar eventos y misiones diarias",
    ["Display Level+3 Quest Givers"] = "Mostrar dadores de misión Nivel+3",
    ["Display Low Level Quest Givers"] = "Mostrar dadores de misión niveles bajos",
    ["Display related creatures and NPCs"] = "Mostrar criaturas y NPCs relacioneados",
    ["Display related items"] = "Mostrar objetos relacionados",
    ["Display related objects like ores, herbs, chests, etc."] = "Muestra objetos relacionados como menas, hierbas, cofres, etc.",
    ["Display related quests"] = "Mostrar misiones relacionadas",
    ["Distance"] = "Distancia",
    ["Do you really want to reset everything?"] = "¿De verdad quieres reiniciarlo todo?",
    ["Do you really want to reset the caches?"] = "¿De verdad quieres reiniciar caches?",
    ["Do you really want to reset the configuration?"] = "¿De verdad quieres reiniciar la configuración?",
    ["Do you really want to reset the quest history?"] = "¿De verdad quieres reiniciar el historial de misiones?",
    ["Draw Favorites On Login"] = "Dibujar favoritos al conectarse",
    ["Enable Minimap Button"] = "Activa el Botón del Minimapa",
    ["Enable Minimap Nodes"] = "Activa los nodes del Minimapa",
    ["Enable Quest Link Support"] = "Activa el Enlace de búsqueda",
    ["Enable Quest Log Buttons"] = "Activa botones de rastreo de misiones",
    ["Enable Quest Tracker"] = "Activar el Rastreador de Búsqueda",
    ["Enable World Map Menu"] = "Activar Menu del Mapa del Mundo",
    ["Exploration Mark"] = "Marca de exploración",
    ["Explore"] = "Explorar",
    ["Explore |cff33ffcc%s|r"] = "Explora |cff33ffcc%s|r",
    ["Friendly"] = "Amistoso",
    ["General"] = "General",
    ["Herbalism"] = "Herboristería",
    ["Hide"] = "Ocultar",
    ["Hide browser window"] = "Oculta ventan del buscador",
    ["Hide Quests"] = "Ocultar misiones",
    ["Highlight Nodes On Mouseover"] = "Resaltar nodos al pasar el ratón por encima",
    ["Hold <Ctrl> To Hide Cluster"] = "Mantenga pulsado <Ctrl> para ocultar el clúster",
    ["Hold <Ctrl> To Hide Minimap Nodes"] = "Mantenga pulsado <Ctrl> para ocultar los nods del minimapa",
    ["Horde"] = "Horda",
    ["Hostile"] = "Hostil",
    ["Include Quest Enders"] = "Incluir finales de misión",
    ["Include Quest Starters"] = "Incluir iniciadores de misiones",
    ["Include Unified Quest Locations"] = "Incluir ubicaciones de Búsqueda Unificada",
    ["Interact with |cff33ffcc%s|r"] = "Interactúa con |cff33ffcc%s|r",
    ["Interact with |cff33ffcc%s|r to complete |cffffcc00[?]|cff33ffcc%s|r"] = "Interactúa con |cff33ffcc%s|rpara completar |cffffcc00[?]|cff33ffcc%s|r",
    ...
    ["Items"] = "Objetos",
    ["Journal"] = "Diario",
    ["Kill |cff33ffcc%s|r"] = "Mata |cff33ffcc%s|r",
    ["Left-Click"] = "Clic izquierdo",
    ["Level"] = "Nivel",
    ["Locales"] = "Lugares",
    ["Location"] = "Ubicación",
    ["Loot"] = "Botín",
    ["Loot and/or Use |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "Botín y/o Uso |cff33ffcc[%s]|r de |cff33ffcc%s|r",
    ...
    ["Minimum Item Drop Chance"] = "Probabilidad mínima de caída de objetos",
    ["Mining"] = "Minar",
    ["Move Button"] = "Mover botón",
    ["N/A"] = "N/D",
    ["Navigation Arrow"] = "Flecha de Navegación",
    ["Node Fade Transparency"] = "Transparencia de desvanecimiento de nodos",
    ["Object"] = "Objeto",
    ["Objects"] = "Objetos",
    ["Online Search"] = "Búsqueda en línea",
    ["Only show cluster icons with summarized objective locations based on spawn points"] = "Mostrar sólo iconos de grupos con ubicaciones de objetivos resumidas basadas en puntos de aparición",
    ["Open Browser"] = "Abrir navegador",
    ["Open Configuration"] = "Abrir configuración",
    ["Open Database Browser"] = "Abrir buscador de base de datos",
    ["Open Settings"] = "Abrir Ajustes",
    ["others"] = "otros",
    ["Please select your preferred |cff33ffccpf|cffffffffQuest|r mode:"] = "Por favor, seleccione su modo preferido |cff33ffccpf|cffffffffMisión|r:",
    ["Query the server for completed quests"] = "Consulta al servidor las misiones completadas",
    ...
    ["Quest Objective Spawn Points (Mini Map)"] = "Puntos de aparición del objetivo de la misión (minimapa)",
    ...
    ["Quest Tracker Font Size"] = "Tamaño de fuente del rastreador de búsqueda",
    ["Quest Tracker Unfold Objectives"] = "Rastreador de búsqueda despliega obnjetivos",
    ["Quest Tracker Visibility"] = "Visibilidad del Rastreador de Búsqueda",
    ["Reaction"] = "Reacción",
    ["Remove all manually searched objects from the map"] = "Eliminar del mapa todos los objetos buscados manualmente",
    ["Required"] = "Requerida",
    ["Required Level"] = "Nivel requerido",
    ["Reset"] = "Reiniciar",
    ["Reset Cache"] = "Reiniciar caché",
    ["Reset Configuration"] = "Reiniciar Configuración",
    ["Reset Everything"] = "Reiniciar Todo",
    ["Reset Language"] = "Reiniciar Lenguaje",
    ["Reset Map"] = "Reiniciar Mapa",
    ["Reset Quest History"] = "Reiniciar Historial de Misiones",
    ["Respawn"] = "Reaparición",
    ...
    ["Search"] = "Buscar",
    ["Search item vendors"] = "Buscar artículos de vendedores",
    ...
    ["Show all taxi nodes of [faction]"] = "Mostrar todos los nodos de taxi de [facción]",
    ["Show Arrow Along Routes"] = "Mostrar flecha a lo largo de las rutas",
    ["Show cluster icons with summarized locations and also display all spawn points of each quest objective"] = "Mostrar iconos de grupos con ubicaciones resumidas y también mostrar todos los puntos de aparición de cada objetivo de búsqueda.",
    ["Show configuration interface"] = "Mostrar interfaz de configuración",
    ["Show Current Quests"] = "Mostrar misiones actuales",
    ["Show Database IDs"] = "Mostrar ID de base de datos",
    ["Show database interface"] = "Mostrar la interfaz de la base de datos",
    ["Show Database Results"] = "Mostrar resultados de la base de datos",
    ["Show Help On Tooltips"] = "Mostrar ayuda en el cuadro de texto",
    ...
    ["Show herbs with skill range of [min] to [max]"] = "Mostrar hierbas con rango de habilidad de [min] a [max]",
    ["Show Level On Quest Log"] = "Mostrar el nivel en el registro de misiones",
    ["Show Level On Quest Tracker"] = "Mostrar el nivel en el rastreador de misiones",
    ["Show map tracker"] = "Mostrar rastreador de mapa",
    ...
    ["Show mines with skill range of [min] to [max]"] = "Mostrar minas con rango de habilidad de [mín] a [máx]",
    ["Show Navigation Arrow"] = "Mostrar la flecha de navegación",
    ["Show navigation arrow that points you to the nearest quest location."] = "Muestra la flecha de navegación que te señala el lugar de misiones más cercano.",
    ["Show quest arrow"] = "Mostrar flecha de misiones",
    ["Show Quest Givers"] = "Mostrar dadores de misiones",
    ["Show quest journal"] = "Mostrar diario de misiones",
    ["Show Route Between Objects"] = "Mostrar ruta entre objetivos",
    ["Show Route On Minimap"] = "Muestra ruta en el Minimapa",
    ["Show specific quest"] = "Muestra misiones específicas",
    ["Show Tooltips"] = "Mostrar información del cuadro de texto",
    ["Simple Markers"] = "Marcadores simples",
    ["Sold by"] = "Vendido por",
    ["Spawn Points"] = "Puntos de aparación",
    ...
    ["Unit"] = "Unidad",
    ["Units"] = "Unidades",
    ["Use |cff33ffcc%s|r at |cff33ffcc%s|r"] = "utilizar |cff33ffcc%s|r en |cff33ffcc%s|r",
    ["Use |cff33ffcc%s|r on |cff33ffcc%s|r"] = "utilizar |cff33ffcc%s|r sobre |cff33ffcc%s|r",
    ["Use Cut-Out Minimap Node Icons"] = "Utilizar los iconos recortados de los nodos del Minimapa",
    ["Use Cut-Out World Map Node Icons"] = "Utilizar los iconos recortados de los nodos del Mapa del Mundo",
    ["Use Monochrome Cluster Icons"] = "Utilice iconos de grupo monocromáticos",
    ["Use Quest Item at |cff33ffcc%s|r"] = "Utilice el objeto de misión en |cff33ffcc%s|r",
    ["User Data"] = "Datos de Usuario",
    ["Use <Shift>-Click To Mark Quest As Done"] = "Utilizar <Shift>-Clic para marcar búsqueda como realizada",
    ["Use <Shift>-Click To Remove Nodes"] = "Utilizar <Shift>-Clic para eliminar nodos",
    ["Vendor"] = "Vendedor",
    ["World Map Node Transparency"] = "Transparencia de los nodos del Mapa del Mundo",
