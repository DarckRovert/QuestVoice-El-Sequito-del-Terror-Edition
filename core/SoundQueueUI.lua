...
function SoundQueueUI:InitDisplay(...)
    self.frame = CreateFrame("Frame", "VoiceOverFrame", UIParent, nil)
    ...
    self.frame.background:SetTexture([[Interface\AddOns\QuestVoice\Textures\BackgroundGradient]])
    ...
    self.frame.resizer:SetWidth(16); self.frame.resizer:SetHeight(16)
    self.frame.resizer:SetNormalTexture([[Interface\AddOns\QuestVoice\Textures\SizeGrabber-Up]])
    self.frame.resizer:SetPushedTexture([[Interface\AddOns\QuestVoice\Textures\SizeGrabber-Down]])
    self.frame.resizer:SetHighlightTexture([[Interface\AddOns\QuestVoice\Textures\SizeGrabber-Highlight]])
    ...
    self.frame.container.stopGossip:SetWidth(32); self.frame.container.stopGossip:SetHeight(32)
    ...
    function self.frame.container.stopGossip:SetGossipCount(gossipCount, ...)
        local texture = gossipCount > 1 and [[Interface\AddOns\QuestVoice\Textures\StopGossipMore]] or [[Interface\AddOns\QuestVoice\Textures\StopGossip]]
...
function SoundQueueUI:InitPortraitLine(...)
    ...
    self.frame.portraitLine:SetTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
    ...
    self.frame.miniPause:SetWidth(26); self.frame.miniPause:SetHeight(26)
    ...
    self.frame.miniPause:SetNormalTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
    ...
    self.frame.miniPause:SetPushedTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
    ...
    self.frame.miniPause.background:SetTexture([[Interface\AddOns\QuestVoice\Textures\SettingsButton]])
    self.frame.miniPause.background:SetPoint("CENTER")
    self.frame.miniPause.background:SetWidth(32); self.frame.miniPause.background:SetHeight(32)
...
function SoundQueueUI:InitPortrait(...)
    ...
    self.frame.portrait:SetWidth(PORTRAIT_SIZE); self.frame.portrait:SetHeight(PORTRAIT_SIZE)
    ...
    self.frame.portrait.background:SetTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameBackground]])
    ...
    self.frame.portrait.book:SetTexture([[Interface\AddOns\QuestVoice\Textures\Book]])
    ...
    self.frame.portrait.pause.background:SetTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameBackground]])
    self.frame.portrait.pause.background:SetAlpha(0.75)
    self.frame.portrait.pause:SetNormalTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
    ...
    self.frame.portrait.pause:SetPushedTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
    ...
    self.frame.portrait.border.texture:SetWidth(PORTRAIT_BORDER_SIZE); self.frame.portrait.border.texture:SetHeight(PORTRAIT_BORDER_SIZE)
    ...
    self.frame.portrait.border.texture:SetTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
...
function SoundQueueUI:InitMover(...)
    ...
    self.frame.mover:SetWidth(26); self.frame.mover:SetHeight(26)
    self.frame.mover:SetPoint("CENTER", self.frame.portrait.border, "BOTTOMLEFT", 5, 6)
    self.frame.mover:SetNormalTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
    ...
    self.frame.mover:SetPushedTexture([[Interface\AddOns\QuestVoice\Textures\PortraitFrameAtlas]])
    ...
    self.frame.mover.background:SetTexture([[Interface\AddOns\QuestVoice\Textures\SettingsButton]])
    self.frame.mover.background:SetPoint("CENTER")
    self.frame.mover.background:SetWidth(32); self.frame.mover.background:SetHeight(32)
...
function SoundQueueUI:InitMinimapButton(...)
    ...
    local object = LibDataBroker:NewDataObject("VoiceOver", {
        type = "launcher",
        text = "VoiceOver",
        icon = [[Interface\AddOns\QuestVoice\Textures\MinimapButton]],
...
function SoundQueueUI:CreateButton(i, ...)
    ...
    button.iconWidget:SetWidth(16); button.iconWidget:SetHeight(16)
    ...
    function button:Update(pushed, hovered)
        ...
        if hovered then
            ...
            self.textWidget:SetShadowColor(0, 0, 0, 1)
            self.iconWidget:SetTexture([[Interface\AddOns\QuestVoice\Textures\SoundQueueBulletDelete]])
            self.iconWidget:SetWidth(14); self.iconWidget:SetHeight(14)
        else
            if isBeingPlayed then
                ...
                if Enums.SoundEvent:IsQuestEvent(event) then
                    ...
                    if event == Enums.SoundEvent.QuestAccept then
                        self.iconWidget:SetTexture([[Interface\AddOns\QuestVoice\Textures\SoundQueueBulletAccept]])
                    elseif event == Enums.SoundEvent.QuestProgress then
                        self.iconWidget:SetTexture([[Interface\AddOns\QuestVoice\Textures\SoundQueueBulletProgress]])
                    elseif event == Enums.SoundEvent.QuestComplete then
                        self.iconWidget:SetTexture([[Interface\AddOns\QuestVoice\Textures\SoundQueueBulletComplete]])
                    end
                elseif Enums.SoundEvent:IsGossipEvent(event) then
                    self.textWidget:SetTextColor(1, 1, 1)
                    self.iconWidget:SetTexture([[Interface\AddOns\QuestVoice\Textures\SoundQueueBulletGossip]])
                end
                self.iconWidget:SetWidth(14); self.iconWidget:SetHeight(14)
            else
                self.textWidget:SetTextColor(123 / 255, 147 / 255, 167 / 255)
                self.iconWidget:SetTexture([[Interface\AddOns\QuestVoice\Textures\SoundQueueBulletQueue]])
                self.iconWidget:SetWidth(22); self.iconWidget:SetHeight(22)
            end
        end
    end
